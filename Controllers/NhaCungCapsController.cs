...
namespace CuaHangDoAn.Controllers
{
    public class NhaCungCapsController : Controller
    {
        ...
        public NhaCungCapsController(CuaHangDoAnContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.NhaCungCaps != null ? 
                          ...
                          Problem("Entity set 'CuaHangDoAnContext.NhaCungCaps'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Ten,DiaChi,Sdt")] NhaCungCap nhaCungCap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ten,DiaChi,Sdt")] NhaCungCap nhaCungCap)
        {
            if (id != nhaCungCap.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CuaHangDoAnContext.NhaCungCaps'  is null.");
            }
            var nhaCungCap = await _context.NhaCungCaps.FindAsync(id);
            if (nhaCungCap != null)
            {
